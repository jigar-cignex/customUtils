...
import { QnAMakerOptions } from 'botbuilder-ai/src/qnamaker-interfaces/qnamakerOptions';
import {RankerTypes} from 'botbuilder-ai/src/qnamaker-interfaces/rankerTypes';
import { FeedbackRecord, FeedbackRecords, QnAMakerMetadata } from 'botbuilder-ai/src/qnamaker-interfaces';
import {QnACardBuilder} from 'botbuilder-ai/src/qnaCardBuilder';
import {QnAMaker, QnAMakerResult } from 'botbuilder-ai/src/index';
import { Activity, ActivityTypes } from 'botbuilder-core';
import { ActiveLearningUtils } from 'botbuilder-ai/src/qnamaker-utils/activeLearningUtils';
